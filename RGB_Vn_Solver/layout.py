"""
This file should be replaced by layout.py in networkx/drawing in site-packages
******
Layout
******
This file should be replaced by the
...
def ellipse_layout(G, horizontal, vertical, scale=1, center=None, dim=2):
    import numpy as np
    ...
    if len(G) == 0:
        ...
        pos = np.column_stack(
            [horizontal * np.cos(theta), vertical * np.sin(theta), np.zeros((len(G), paddims))]
        )
